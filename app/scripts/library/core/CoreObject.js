...
define([
    ...
    var CoreObject = extend(Object, {
        ...
        return {
             ...
             * are non-configurable, and non-writable, so trying to override them will throw an error. They will
             * be used for introspection later.
             *
             * @param {Object} instanceProps An object who's properties will be copied onto the new instance.
             */
            ...
            /**
             * Use has for duck-typing your instances. Checks if 'key' is an own property of this instance.
             *
